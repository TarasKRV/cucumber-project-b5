...
public class GoogleSearchStepDefs {
    ...
    @Then("user should be see {string} in the results as capital")
    public void user_should_be_see_in_the_results_as_capital(String capital) {
        assertEquals(googleSearchPage.searchResults.getText(), capital, googleSearchPage.searchResults.getText());
    }
...
//        }
    ...
    @Then("user searching the following items")
    public void user_searching_the_following_items(List<Map<String, String>> items) {
